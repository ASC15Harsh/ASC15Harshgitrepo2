...
public class q5 {
    public static void main(String[] args) {
        ...
        System.out.println(movie1.showDetails()); // Call the showDetails() method
        ...
        System.out.println(movie2.showDetails()); // Call the showDetails() method
        ...
        System.out.println(specialMovie.showDetails()); // Call the showDetails() method
        ...
        System.out.println(internationalMovie.showDetails()); // Call the showDetails() method
